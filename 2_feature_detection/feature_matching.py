...
if __name__ == "__main__":
    ...
    path1 = "../media/collection/book1.jpg"
    path2 = "../media/collection/book2.jpg"
    ...
    video_path = "../media/collection/books.mov"
    ...
    while ret:
        ...
        match = generic_matcher(img1, frame, kp_detector=ORB)
        #match = flann_matcher(img1, frame, kp_detector=SIFT)
        #match = bf_matcher(img1, frame, kp_detector=SIFT)

        cv2.imshow('out', match)
        #cv2.imwrite(f'../media/out/feature_matching/frames/{n}.jpg', match)
